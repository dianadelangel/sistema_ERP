<?php
    ...
    if(empty($_REQUEST['id']))
     {
         header("location:eliminar_product.php");
     }else{
        
        
        $id= $_REQUEST['id'];

        $query = mysqli_query($conexion,"SELECT * FROM productos WHERE num_pro='$id'");
...
<body>
    ...
    <div class="mostrar_delete">
        ...
        <form method="post" action="">
            ...
            <a href="../principal.html" class="btn_cancel">Cancelar</a>
