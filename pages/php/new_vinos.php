    ...
    <div class="container">
        ...
        <form action="" method="post">
            <div class="entradas">
                ...
                <label for="categoria">
                    <span>Categoría</span>
                    <input type="text" name="categoria" id="categoria" value="Botanas y Vinos">
                </label>
            </div>
            <div class="entradas">
            ...
            <label for="mono">Moño</label>
                ...
                <div class="entradas">
                <label for="follaje">Capacidad</label>
                <select name="follaje" id="follaje">
                    <option>187 ml</option>
                    <option>200 ml</option>
                    <option selected="selected">750 ml</option>
                </select>

                <label for="material">Aroma</label>
