...
<body>
    ...
    <!-- Creación del titulo-->
    <div class="title">
        <h1 class="lines-effect">Clasificación Regalos</h1>
    </div>
    ...
    <div class="datatable-container">
        ...
        <table class="datatable">
            ...
            <tbody>
                ...
                $sql="SELECT * FROM clasificaciones WHERE categoria='Regalos'";
                ...
                <tr>
                    ...
                    <td><a href="../../php/modificar_clregalos.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-solid fa-pen-to-square fa-lg" style="color:white"></i></a></td>
                    <td><a href="eliminar_clregalos.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-sharp fa-solid fa-trash fa-lg" style="color:white"></i></a></td>
                </tr>
                <?php
                }
                ?>
