<?php
    ...
    $alert = "";
     if(!empty($_POST))
     {
        ...
        if($query_delete){
            header("location:clasif_regalos.php");
        }else{
            $alert='<p class="msg_error">Error al eliminar.</p>';
        }
    }
    if(empty($_REQUEST['id']))
     {
         header("location:eliminar_clregalos.php");
     }else{
...
<nav>
    ...
    <div class="register">
        <a href="clasif_regalos.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
    ...
    <div class="mostrar_delete">
        ...
        <form method="post" action="">
            ...
            <a href="clasif_regalos.php" class="btn_cancel">Cancelar</a>
