    ...
    <div class="datatable-container">
        ...
        <table class="datatable">
            ...
            <tbody>
                ...
                $sql="SELECT * FROM clasificaciones WHERE categoria='Postres'";
                ...
                <tr>
                    ...
                    <td><a href="../../php/modificar_clpostres.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-solid fa-pen-to-square fa-lg" style="color:white"></i></a></td>
                    <td><a href="eliminar_clpostres.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-sharp fa-solid fa-trash fa-lg" style="color:white"></i></a></td>
                </tr>
                <?php
                }
                ?>
