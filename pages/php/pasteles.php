...
<body>
    ...
    <table class="datatable">
            ...
            <tbody>
                ...
                $sql_register=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM productos WHERE clasificacion = 'Pasteles'");
                ...
                $sql="SELECT * FROM productos WHERE clasificacion='Pasteles' ORDER BY num_pro ASC
