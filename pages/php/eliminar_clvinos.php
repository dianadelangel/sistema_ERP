<?php
    ...
    $alert = "";
     if(!empty($_POST))
     {
        ...
        if($query_delete){
            header("location:clasif_vinos.php");
        }else{
    ...
    if(empty($_REQUEST['id']))
     {
         header("location:eliminar_clvinos.php");
     }else{
...
<nav>
    ...
    <!-- Creación del titulo-->
    <div class="title">
        <h1 class="lines-effect">Clasificación Vinos</h1>
    </div>

    <div class="register">
        <a href="clasif_vinos.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
