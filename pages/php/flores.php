...
<body>
    ...
    <div class="register">
        <a href="new_product.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
    ...
    <table class="datatable">
            ...
            <tbody>
                ...
                $sql_register=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM productos WHERE clasificacion = 'Flores Blancas'");
                ...
                $sql="SELECT * FROM productos WHERE clasificacion='Flores Blancas' ORDER BY num_pro ASC
        ...
        <div class=ganancia>
            ...
            <?php
            include('../../php/conexion.php');
                $sql_v =mysqli_query($conexion, "SELECT * FROM productos WHERE clasificacion='Flores Blancas'");
                $ganancia =0;
