...
<body>
    ...
    <!-- Creación del titulo-->
    <div class="title">
        <h1 class="lines-effect">Categorías</h1>
    </div>

    <!-- Botón de registro-->
    <div class="register">
        <a href="new_category.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
        ...
        <table class="datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $mostrar['ID_category']?></td>
                    <td><?php echo $mostrar['Nombre']?></td>
                    <td><?php echo $mostrar['Descripcion']?></td>
                    <td><a href="../../php/modificar.php?id=<?php echo $mostrar["num"]; ?>"><i class="fa-solid fa-pen-to-square fa-lg" style="color:white"></i></a></td>
                    <td><a href="../php/eliminar_category.php?id=<?php echo $mostrar["num"]; ?>"><i class="fa-sharp fa-solid fa-trash fa-lg" style="color:white"></i></a></td>
                </tr>
                <?php
                }
                ?>
