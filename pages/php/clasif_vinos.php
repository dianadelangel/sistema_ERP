...
<body>
    ...
    <!-- Creación del titulo-->
    <div class="title">
        <h1 class="lines-effect">Clasificación Botanas y Vinos</h1>
    </div>
    ...
    <div class="datatable-container">
        ...
        <table class="datatable">
            ...
            <tbody>
                ...
                $sql="SELECT * FROM clasificaciones WHERE categoria='Botanas y Vinos'";
                ...
                <tr>
                    ...
                    <td><a href="../../php/modificar_clvinos.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-solid fa-pen-to-square fa-lg" style="color:white"></i></a></td>
                    <td><a href="eliminar_clvinos.php?id=<?php echo $mostrar["num_cl"]; ?>"><i class="fa-sharp fa-solid fa-trash fa-lg" style="color:white"></i></a></td>
                </tr>
                <?php
                }
                ?>
