<?php
    include('../../php/conexion.php');
     ...
     if(!empty($_POST))
     {
        ...
        if($query_delete){
            header("location:clasif_globos.php");
        }else{
    ...
    if(empty($_REQUEST['id']))
     {
         header("location:eliminar_clglobos.php");
     }else{
...
<nav>
    ...
    <div class="register">
        <a href="clasif_globos.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
    ...
    <div class="mostrar_delete">
        ...
        <form method="post" action="">
            ...
            <a href="clasif_globos.php" class="btn_cancel">Cancelar</a>
