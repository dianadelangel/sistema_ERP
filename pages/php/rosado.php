...
<body>
    ...
    <table class="datatable">
            ...
            <tbody>
                ...
                $sql_register=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM productos WHERE clasificacion = 'Rosado'");
                ...
                $sql="SELECT * FROM productos WHERE clasificacion='Rosado' ORDER BY num_pro ASC
        ...
        <div class=ganancia>
            ...
            <?php
            include('../../php/conexion.php');
                $sql_v =mysqli_query($conexion, "SELECT * FROM productos WHERE clasificacion='Rosado'");
                $ganancia =0;
