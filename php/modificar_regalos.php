        ...
        $follaje=$_POST['follaje'];
            ...
            color='$color', material='$material',detalles='$detalles', mono='$mono', follaje='$follaje', clasificacion='$clasificacion'
             ...
             if($sql_update){
                ...
                header("Location:modificar_regalos.php");
             }else{
...
include 'conexion.php';
if(empty($_GET['id'])){
    header('Location:../pages/regalos.html');
}
$id_datos=$_GET['id'];
...
<body>
    ...
    <div class="register">
        <a href="../pages/regalos.html" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <label for="clasificacion">Clasificación</label>
                <?php
                include 'conexion.php';
                     $query_act=mysqli_query($conexion,"SELECT *FROM clasificaciones where categoria=3");
