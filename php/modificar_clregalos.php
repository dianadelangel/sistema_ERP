    ...
    if(empty($_POST['name']) || empty($_POST['categoria']))
    {
        ...
        $categoria=$_POST['categoria'];
            ...
            $sql_update=mysqli_query($conexion,"UPDATE clasificaciones SET nombre_cl = '$nombre'  WHERE num_cl = '$id_clasificacion'");
             ...
             if($sql_update){
                $alert='<p class="msg_save">La clasificacion se ha actualizado de manera exitosa.</p>';
                header("Location:../pages/php/clasif_regalos.php");
             }else{
...
<body>
    ...
    <div class="register">
        <a href="../pages/php/clasif_regalos.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
