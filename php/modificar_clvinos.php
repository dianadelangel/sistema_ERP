        ...
        $categoria=$_POST['categoria'];
            ...
            $sql_update=mysqli_query($conexion,"UPDATE clasificaciones SET nombre_cl = '$nombre'  WHERE num_cl = '$id_clasificacion'");
             ...
             if($sql_update){
                ...
                header("Location:../pages/php/clasif_vinos.php");
             }else{
                $alert='<p class="msg_error">La clasificación no se ha podido actualizar.</p>';
            }
        }
    }
...
<body>
    ...
    <div class="register">
        <a href="../pages/php/clasif_vinos.php" class="btn-neon">
            <span id="span1"></span>
            <span id="span2"></span>
            <span id="span3"></span>
            <span id="span4"></span>
